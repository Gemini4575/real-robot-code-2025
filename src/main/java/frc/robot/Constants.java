...
public class Constants {
    ...
    public static final class FieldConstants {
        ...
        public static class Reef {
            ...
            public static final double faceToZoneLine = Units.inchesToMeters(12); // Side of the reef to the inside of
                                                                                  // the reef zone line
            ...
            public static final Pose2d[] centerFaces = new Pose2d[6]; // Starting facing the driver station in clockwise
                                                                      // order
            public static final List<Map<ReefHeight, Pose3d>> branchPositions = new ArrayList<>(); // Starting at the
                                                                                                   // right branch
                                                                                                   // facing the driver
                                                                                                   // station in
                                                                                                   // clockwise
    ...
    public static final class SwerveConstants {
        // these are distance from the center to the wheel in meters. .381 is 1.25 feet
        // or 16 inches
         ...
         * 0.45085
         * private final Translation2d m_frontLeftLocation = new Translation2d(0.45085,
         * 0.45085);
         * private final Translation2d m_frontRightLocation = new Translation2d(0.45085,
         * -0.45085);
         * private final Translation2d m_backLeftLocation = new Translation2d(-0.45085,
         * 0.45085);
         * private final Translation2d m_backRightLocation = new Translation2d(-0.45085,
         * -0.45085);
         * 
        ...
        // FWF - stole this from 6328's code, each gear reduction written out. Final is
        // 6.75. 39.37 converts inches to meters so we can be european fancy
        // private final double driveAfterEncoderReduction = (50.0 / 14.0) * (17.0 /
        // 27.0) * (45.0 / 15.0);
        // public static final double driveAfterEncoderReduction = (4.0 / 39.37) *
        // Math.PI * (1/6.75);
        // public static final double driveAfterEncoderReduction = 0.0788114854; // FWF
        // this is the above calc * 1.6667 to see if the auto distance changes
        ...
        public static final class Mod0 {
            ...
            public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
                    canCoderID, speedAdjustmentFactor);
        }
    ...
    public final static class Autos {
        public static final MotionDirective[] AUTO_WITH_CAM = new MotionDirective[] { strafe(82), dropCoral(), stop(),
                GetCoral(), drive(-200), strafe(196) };
        public static final MotionDirective[] AUTO_CORAL1 = new MotionDirective[] { drive(68.0), turn(80), dropCoral(),
                stop() };
        public static final MotionDirective[] AUTO_CORAL2 = new MotionDirective[] { drive(79.0), turn(80), dropCoral(),
                stop(),
                GetCoral(), drive(-95), turn(-85), drive(170), strafe(-30), turn(-25), turn(75), strafe(35),
                drive(25), wait2(1), GetCoral(), turn(180), strafe(175), dropCoral(), stop(), GetCoral() };// ]\[],
                                                                                                           // turn(-10),
                                                                                                           // drive(-Units.inchesToMeters(90)),
                                                                                                           // strafe(Units.inchesToMeters(230))};
